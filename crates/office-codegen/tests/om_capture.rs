...
fn loads_office_idl_excel_om_template_and_summarizes_surface() {
    ...
    assert_eq!(summary.member_count, 760);
    assert_eq!(summary.stub_member_count, 760);
    assert_eq!(
...
fn summarizes_focus_surface_registry_and_coverage_from_template_document() {
    ...
    assert_eq!(picture_format.member_count, 11);
    ...
    assert_eq!(coverage.member_count, 760);
    assert_eq!(coverage.support_counts.stub, 760);
    ...
    assert_eq!(picture_format_coverage.member_count, 11);
    assert_eq!(picture_format_coverage.support_counts.stub, 11);
    assert_eq!(
    ...
    assert_eq!(three_d_format_coverage.member_count, 5);
    assert_eq!(three_d_format_coverage.support_counts.stub, 5);
    assert_eq!(
    ...
    assert_eq!(text_frame2_coverage.member_count, 4);
    assert_eq!(text_frame2_coverage.support_counts.stub, 4);
    assert_eq!(

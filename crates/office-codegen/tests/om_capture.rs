...
fn loads_office_idl_excel_om_template_and_summarizes_surface() {
    ...
    assert_eq!(summary.member_count, 846);
    assert_eq!(summary.stub_member_count, 846);
    assert_eq!(
...
fn summarizes_focus_surface_registry_and_coverage_from_template_document() {
    ...
    assert_eq!(tick_labels.member_count, 15);
    ...
    assert_eq!(coverage.member_count, 846);
    assert_eq!(coverage.support_counts.stub, 846);
    ...
    assert_eq!(tick_labels_coverage.member_count, 15);
    assert_eq!(tick_labels_coverage.support_counts.stub, 15);
    assert_eq!(

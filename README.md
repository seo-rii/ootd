...
- `excel-runtime` formula evaluation for arithmetic, comparisons, logical/control helpers, aggregates, criteria aggregates, lookup/reference helpers, error/info helpers, and `Application`/`Worksheet.Evaluate`,

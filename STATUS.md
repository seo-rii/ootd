...
- Current root test inventory: 720 `excel-runtime` tests and 2,874 `excel-xlsx` tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  records alone may reach the separate XLSX graph preflight. Orphan data, exact package/model sheet
  identity, chart/drawing/support graph ownership, and field encapsulation remain open. Details are in

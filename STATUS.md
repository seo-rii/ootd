...
- Current root test inventory: 719 `excel-runtime` tests and 2,868 `excel-xlsx` tests.
...
- Worksheet A1 cell-reference boundary: ASCII column/row grammar, optional absolute markers,
  ...
  range endpoints, centralized model limits, and cross-consumer migration remain open. Details are
  in `docs/interfaces/worksheet_a1_cell_references.md`.

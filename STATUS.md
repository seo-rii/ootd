...
- Current root test inventory: 118 `excel-model`, 775 `excel-runtime`, and 2,925 `excel-xlsx`
  tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  merged-cell and standard multi-area data-validation ranges fail closed only when they intersect
  the exact shift corridor, and reference-bearing standard validation formulas fail closed
  workbook-wide before corridor planning; extension-backed validation, tables, charts, drawings,
  and raw worksheet metadata remain outside this bounded command.
  Details are in

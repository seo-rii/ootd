...
- Current root test inventory: 112 `excel-model`, 759 `excel-runtime`, and 2,920 `excel-xlsx`
  tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  Find, and workbook dirty state. Structural reference and raw worksheet-metadata retargeting
  remain outside this bounded command.
  Details are in
...
- CI portability: Ubuntu Rust 1.94, Ubuntu MSRV Rust 1.88, and Windows Rust 1.94 run as independent
  test lanes. A bounded rustfmt gate covers 58 tracked files with four guarded monolith exceptions;

...
- Current root test inventory: 719 `excel-runtime` tests and 2,858 `excel-xlsx` tests.
...
- CI portability: Ubuntu Rust 1.94, Ubuntu MSRV Rust 1.88, and Windows Rust 1.94 run as independent
  test lanes. A bounded rustfmt gate covers 51 tracked files with four guarded monolith exceptions;

...
- Current root test inventory: 97 `excel-model`, 728 `excel-runtime`, and 2,920 `excel-xlsx`
  tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  `OOTD-054`; `Range.Clear` and style-only `ClearFormats` are the first payload mutations routed

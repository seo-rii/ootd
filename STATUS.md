...
- Current root test inventory: 117 `excel-model`, 774 `excel-runtime`, and 2,925 `excel-xlsx`
  tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  the exact shift corridor, while extension-backed validation, tables, charts, drawings, and raw
  worksheet metadata remain outside this bounded command.
  Details are in

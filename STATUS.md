...
- Current root test inventory: 95 `excel-model`, 724 `excel-runtime`, and 2,920 `excel-xlsx`
  tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  atomic through late content-types failures. Collection-wide multi-sheet Delete, target-less Copy

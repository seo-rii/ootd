...
- Current root test inventory: 720 `excel-runtime` tests and 2,909 `excel-xlsx` tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  charts retain preserve-only behavior. Orphan data, support-snapshot graph ownership, and field
  encapsulation remain open. Details are in `docs/interfaces/workbook_state_save_validation.md` and

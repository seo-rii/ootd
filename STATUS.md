...
- Current root test inventory: 112 `excel-model`, 756 `excel-runtime`, and 2,920 `excel-xlsx`
  tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  first payload mutations routed through spill-aware atomic model commands. Structural reference
  and raw worksheet-metadata retargeting remain outside this bounded command.
  Details are in

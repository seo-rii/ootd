...
- Current root test inventory: 113 `excel-model`, 770 `excel-runtime`, and 2,921 `excel-xlsx`
  tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  Structural reference and raw worksheet-metadata retargeting remain outside this bounded command.
  Details are in

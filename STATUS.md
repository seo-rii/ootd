...
- Current root test inventory: 114 `excel-model`, 771 `excel-runtime`, and 2,921 `excel-xlsx`
  tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  A1/R1C1 cell-formula owners now fail closed before structural mutation; defined names, tables,

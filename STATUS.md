...
- Current root test inventory: 115 `excel-model`, 772 `excel-runtime`, and 2,921 `excel-xlsx`
  tests.
...
- Workbook-state save boundary: decoded and live states must retain unique bounded worksheet IDs,
  ...
  A1/R1C1 cell-formula and defined-name owners now fail closed before structural mutation; tables,
  validation, charts, drawings, merged cells, and raw worksheet metadata remain outside this bounded
  command.
  Details are in
